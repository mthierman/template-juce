    ...
    -> juce::String
{
    ...
    std::unordered_map<juce::String, juce::String> mimeTypes = {
        {"txt", "text/plain"},      {"md", "text/markdown"},    {"htm", "text/html"},
        {"html", "text/html"},      {"css", "text/css"},        {"js", "text/javascript"},
        {"mjs", "text/javascript"}, {"csv", "text/csv"},        {"json", "application/json"},
        {"otf", "font/otf"},        {"ttf", "font/ttf"},        {"woff", "font/woff"},
        {"woff2", "font/woff2"},    {"avif", "image/avif"},     {"ico", "image/vnd.microsoft.icon"},
        {"jpg", "image/jpeg"},      {"jpeg", "image/jpeg"},     {"gif", "image/gif"},
        {"png", "image/png"},       {"webp", "image/webp"},     {"tif", "image/tiff"},
        {"tiff", "image/tiff"},     {"svg", "image/svg+xml"},   {"svgz", "image/svg+xml"},
        {"bmp", "image/bmp"},       {"mid", "audio/midi"},      {"midi", "audio/midi"},
        {"aac", "audio/aac"},       {"aif", "audio/aiff"},      {"aiff", "audio/aiff"},
        {"wav", "audio/wav"},       {"ogg", "audio/ogg"},       {"flac", "audio/flac"},
        {"mp3", "audio/mpeg"},      {"weba", "audio/webm"},     {"webm", "video/webm"},
        {"mp4", "video/mp4"},       {"mpeg", "video/mpeg"},     {"wasm", "application/wasm"},
        {"pdf", "application/pdf"}, {"rtf", "application/rtf"}, {"xml", "application/xml"},
        {"zip", "application/zip"}};
